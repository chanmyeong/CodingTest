// [참고문헌]: https://roytravel.tistory.com/340
// [참고문헌]: https://velog.io/@kkimbj18/%EB%B2%A8%EB%A7%8C-%ED%8F%AC%EB%93%9C-%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98
// 벨만 포드 알고리즘은 가중 유향 그래프 상에서 특정 한 노드로 부터 다른 노드까지의 최단 경로를 구하는 알고리즘이다.
// 다익스트라 알고리즘의 간선이 음수일 때 최단 경로를 구할 수 없다는 한계점을 보완하기 위해 나왔다.
...
//        }
    ...
    private static boolean bellmanFord() {
        ...
        // => 음의 사이클이 발생하게 되면 원래 간선의 개수보다 갱신되는 간선의 개수가 늘어남(멈추지 않을 경우 그 개수는 무한대에 수렴)
